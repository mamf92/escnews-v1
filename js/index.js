...
function setupCarousel() {
    ...
    const backButton = document.querySelector('.carousel__control__button.arrow-left');
    const nextButton = document.querySelector('.carousel__control__button.arrow-right');
